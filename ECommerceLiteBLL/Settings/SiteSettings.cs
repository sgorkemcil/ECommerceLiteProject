...
namespace ECommerceLiteBLL.Settings
{
    public class SiteSettings
    {
        ...
        //Bu metot bir hata veriyor hataya bakıp çözmeye çalışacağız...
        ...
        //                        + "<body>" + model.Message
        //                        + "<img style='float:left' width:'250px' height:'250px' src='cid:" + resource.ContentId + "'/>" + "</body></html>";
        ...
        //        //
        //        AlternateView alternativeView = AlternateView.CreateAlternateViewFromString(htmlBody,Encoding.UTF8,MediaTypeNames.Text.Html);
        //        alternativeView.LinkedResources.Add(resource);
